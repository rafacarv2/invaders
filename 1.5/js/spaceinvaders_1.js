...
PlayState.prototype.update = function(game, dt) {
    ...
    if (frame_hit == 0) {
        ...
        if (this.invaders.length === 0) {
            ...
            game.level += 1;
//            if (game.level > 1) {game.moveToState(new VictoryState(game.level));} else {
                game.moveToState(new LevelIntroState(game.level));
//            }
        }
...
PlayState.prototype.draw = function(game, dt, ctx) {
    ...
    if (frame_hit > 0) {
        ...
        ctx.drawImage(
                ...
                this.ship.x - (this.ship.width / 2), this.ship.y - 10 - (this.ship.height / 2), //x,y
                36, 36//width,height
                );
    } else {
        ShipSY = 181;
...
//    var info = "Vidas: " + game.lives + ", Força do laser: 10";
    var info = "Calor";
    ctx.textAlign = "left";
    ctx.fillText(info, game.gameBounds.right - 45, (game.gameBounds.bottom / 2) + 185);
